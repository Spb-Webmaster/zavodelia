...
<x-seo.meta
    title="Кабинет менеджера / Изображения / Пользователь  {{$item->name}} "
    description="Кабинет менеджера /  Изображения /Пользователь  {{$item->name}} "
    keywords="Кабинет менеджера /  Изображения / Пользователь  {{$item->name}} "
/>
@section('cabinet')
    <div class="auth">
        <div class="cabinet">
                                                ...
                                                <div class="user25_m__img">
                                                    ...
                                                    >
                                                        <img class="pc_category_img"
                                                             ...
                                                             loading="lazy"
                                                             src="{{ asset(intervention('120x120', $it->img, 'users/' . $item->id  . '/photos')) }}"
                                                             alt="photo_{{ $k }}" title="">
                                                    </a>
