...
<x-seo.meta
    title="Кабинет менеджера / Статьи / Пользователь  {{$item->name}} "
    description="Кабинет менеджера /  Статьи /Пользователь  {{$item->name}} "
    keywords="Кабинет менеджера /  Статьи / Пользователь  {{$item->name}} "
/>
@section('cabinet')
    <div class="auth">
        <div class="cabinet">
                            ...
                            <div class="dashboardBox dashboardBox__a_user ">
                                ...
                                <div class="cabinet_ob_peoles">
                                        ...
                                        @foreach($items as $k=>$it)
                                            <div class="user25_m">
                                                ...
                                                <div class="user25_m__article">
                                                    <div class="user25_m__article_padding">
                                                        <h2><a href="{{ route('m_user_article', ['user_id' => $item->id, 'id' => $it->id]) }}">{{ $it->title }}</a></h2>
                                                                <div class="_teaser_text">
                                                                   {!!  $it->teaser_text !!}
                                                                </div>
                                                        <div class="_article_comments">
                                                ...
                                                <div class="user25_m_trush">
                                                    ...
                                                    <div class="user25_m_trush_solid m_trush__js" data-model="App\Models\UserArticle" data-object="{{ $it->id }}" >
                                    ...
                                    <div class="cart_icon__wrap">
                                        <div class="cart_icon cart_icon__js" data-model="App\Models\UserArticle">
