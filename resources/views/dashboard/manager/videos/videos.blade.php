...
<x-seo.meta
    title="Кабинет менеджера / Новые видеоссылки"
    description="Кабинет менеджера /  Новые видеоссылки "
    keywords="Кабинет менеджера /  Новые видеоссылки"
/>
@section('cabinet')
    <div class="auth">
        <div class="cabinet">
                    ...
                    <div class="cabinet__right">
                        ...
                        <div class="cabinet_radius12_fff">
                            ...
                            <div class="c__title_subtitle">
                                <h3 class="F_h1">{{ __('Видео') }}</h3>
                                <div class="F_h2 pad_t5">
                                    <span>{{ __('Все видеоссылки пользователей сайта.')}}</span>
                                </div>
                            </div>
