<section
    ...
    @if($item->image)
        <div class="elementor-container elementor-column-gap-default pad_t20 pad_b20">
            <div class="desc item_image">
                <img src="{{ Storage::url($item->image) }}" width="100%" style="width: 100%; height: auto"
                     loading="lazy" alt=""/>
            </div>
        </div>
    @endif
                            ...
                            @foreach($item->docs as $d)
                                <div class="_d_item">
                                    <a class="co" href="{{ Storage::url($d['doc'])  }}"
                                       ...
                                       data-caption=""
                                    >
                                        <img src="{{ Storage::url($d['doc'])  }}"
                                             alt="{{ (isset($d['doc_text']))? $d['doc_text'] : ''}}"/>
                                    </a>
    ...
    @if($item->image2)
        <div class="elementor-container elementor-column-gap-default pad_t20 pad_b20">
            <div class="desc item_image">
                <img src="{{ Storage::url($item->image2) }}" width="100%" style="width: 100%; height: auto"
                     loading="lazy" alt=""/>
            </div>
        </div>
    @endif
