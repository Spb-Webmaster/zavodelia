                ...
                <div class="em_single_testimonial witr_testi_s_9">
                    ...
                    <div class="em_testi_content">
                        <div class="em_testi_text">
                            <!-- content -->
                            <p>Our collaboration projects between the public sector, industry and demia bring a real impact for the our health and lab firms. He development</p>									</div>
                    </div>


                    <div class="em_test_thumb">
                        <img loading="lazy" decoding="async" width="73" height="73" src="https://demo.themexbd.com/wpi/techite/wp-content/uploads/2020/12/robotil-testi-1.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" srcset="https://demo.themexbd.com/wpi/techite/wp-content/uploads/2020/12/robotil-testi-1.png 73w, https://demo.themexbd.com/wpi/techite/wp-content/uploads/2020/12/robotil-testi-1-70x70.png 70w" sizes="(max-width: 73px) 100vw, 73px">									</div>

                    <div class="em_testi_title">
                        <h2>Abbie Ferguson <span>Web Designer</span></h2>
                    </div>
                                    ...
                                    @if(count($items))
                                        @foreach($items as $item)
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12  witr_all_mb_30">
                                                <div
                                                    class="row techite-single-event_adn witr_event_style_5 align_item_center">
